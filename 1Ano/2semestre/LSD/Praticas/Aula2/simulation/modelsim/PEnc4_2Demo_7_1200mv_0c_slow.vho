...
-- LEDR1	=>  Location: PIN_AG23,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst|Equal0~0_combout\ = (!\SW[2]~input_o\ & (!\SW[1]~input_o\ & (!\SW[3]~input_o\ & \SW[0]~input_o\)))
