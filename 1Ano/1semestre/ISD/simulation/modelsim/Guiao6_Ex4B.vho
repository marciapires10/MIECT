...
ARCHITECTURE structure OF Guiao6_Ex4B IS
...
-- pragma translate_on
PORT MAP (
	i => \inst|sub|ALT_INV_81~0_combout\,
	devoe => ww_devoe,
	o => \Out~output_o\);
...
-- Equation(s):
-- \inst|sub|81~0_combout\ = (\A~input_o\ & (((!\D~input_o\)))) # (!\A~input_o\ & (\B~input_o\ $ (((\C~input_o\) # (\D~input_o\)))))
